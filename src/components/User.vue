...
export default {
  ...
  methods: {
    fetchUser(userId, token) {
      ...
      .then(data => {
        this.user = {
          ...
          email: data.email,
          phoneNumber: data.phone_number, // Assuming this is how your API returns these fields
          // password: data.password // Password telah dihapus
        };
    ...
    // Metode redirectToEdit telah dihapus
  }
};
</script>
